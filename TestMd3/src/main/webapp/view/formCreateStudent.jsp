...
<body>
<form method="post" action="students?action=createStudent">
  <table class="table table-hover">
    ...
    <tr>
      <th>Date of birth</th>
      <td>
        <input class="form-control" type="date" name="dateOfBirth" size="45"/>
      </td>
    </tr>
    <tr>
      <th>Address</th>
    ...
    <tr>
      <th>Phone Number</th>
      <td>
        <input class="form-control" type="number" name="phoneNumber" size="45"/>
      </td>
    </tr>
    <tr>
      <th>Class</th>
